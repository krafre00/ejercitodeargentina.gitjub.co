// 
/**
 ...
 **
 ** BROWSERJS_TIMESTAMP = '202411181142'; // for versioning; see DNA-54964
 **/
 ...
 if (!location.href.includes('operabrowserjs=no')) {
   (function(document){
     ...
     const version = () => {
         ...
         return `Opera Desktop November 18, 2024. Active patches: ${total}`;
     };
